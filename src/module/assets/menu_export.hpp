...
{
	class menu_export final : public module
	{
	public:
		void post_load() override;
		void export_menu(game::native::menuDef_t* menu, std::string subdir);
		void export_menu_itemdefs(game::native::menuDef_t* menu, std::string subdir);
	...
	private:
		...
		void write_menu_def(game::native::menuDef_t* menuDef);
		void write_statement(std::string name, game::native::statement_s stmt);
		void write_vec4(std::string name, float vec4[]);
		void write_item_def(game::native::itemDef_s& itemDef);
		void write_line(std::string name);
		void write_rect(game::native::rectDef_s rect);
		template <typename T>
		...
		void write_visible(game::native::statement_s stmt);
		...
		const std::string headerText = "//This menu was generated using YACC Client\n//If you find any bug please report them here: https://github.com/lierrmm/yacc/issues\n\n#include \"ui/menudefinition.h\"\n\n";
